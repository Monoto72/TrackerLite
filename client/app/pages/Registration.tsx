export function Registration() {
    return (
        <main className="flex items-center justify-center pt-16 pb-4 bg-gray-700">
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Sign in to your account
                    </h2>
                </div>
